      ...
      <nav class ="row navbar">
        <div class="container">
          <ul class="nav navbar-nav col-12 col-lg-12">
            <li> <a href="chaptersList.php" class="btn-dark col-4 col-lg-4">Chapitres parus
            ...
            <li> <a href="login.php" class="btn-dark col-4 col-lg-4">Connexion
            ...
            <li> <a href="signIn.php" class="btn-dark col-4 col-lg-4">S'inscrire
