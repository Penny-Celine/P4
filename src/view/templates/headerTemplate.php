    ...
    <div class="container">
      <ul class="nav navbar-nav col-12 col-lg-12">
        ...
        //ici, penser à changer la condition après la prise en charge de la session
            if (isset($_SESSION['user']) && isset($_SESSION['privilege']) && $_SESSION['privilege']==='admin')
            {
              echo('
            ...
            <li> <a href="?page=chapitres" class="btn-dark col-2 col-lg-2">Liste des chapitres
            </a></li>
            <li> <a href="?page=nouveau_chapitre" class="btn-dark col-2 col-lg-2">Nouveau Chapitre
            </a></li>
            ...
            <li> <a href="?page=deconnexion" class="btn-dark col-2 col-lg-2">Déconnexion
              ...
              ');
            } else if(isset($_SESSION['user']) && isset($_SESSION['privilege']) && $_SESSION['privilege']==='user')
            {
              echo('
              <li> <a href="index.php" class="btn-dark col-2 col-lg-2">Accueil
              <svg class="bi bi-house-door-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d="M6.5 10.995V14.5a.5.5 0 01-.5.5H2a.5.5 0 01-.5-.5v-7a.5.5 0 01.146-.354l6-6a.5.5 0 01.708 0l6 6a.5.5 0 01.146.354v7a.5.5 0 01-.5.5h-4a.5.5 0 01-.5-.5V11c0-.25-.25-.5-.5-.5H7c-.25 0-.5.25-.5.495z"/>
                <path fill-rule="evenodd" d="M13 2.5V6l-2-2V2.5a.5.5 0 01.5-.5h1a.5.5 0 01.5.5z" clip-rule="evenodd"/>
              </svg>
            </a></li>
            <li> <a href="?page=chapitres" class="btn-dark col-2 col-lg-2">Chapitres parus
            ...
            <li> <a href="?page=inscription" class="btn-dark col-2 col-lg-2">S\'inscrire
            ...
            <li> <a href="?page=contact" class="btn-dark col-2 col-lg-2">Contact
            </a></li>
              ');
            } else
            {
            ...
            <li> <a href="?page=connexion" class="btn-dark col-2 col-lg-2">Connexion
              <svg class="bi bi-person-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="white" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd"/>
              </svg>
            </a></li>
